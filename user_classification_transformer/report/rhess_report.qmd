...
The distribution of the number of tokens per profile description in all five datasets is shown in Figure 1.

![**Figure 1**: Distribution over token lengths in the full dataset](figs/token_lengths.png)
...
The results of our study are shown Table X. 
...
: **Table X**: Our study's results. Measures, where our performance exceeds the original study are printed in bold.

For comparison, the results of the original study are shown in Table X. 
...
: **Table X:** The original study's results using a random forrest classifier [@kwon_disentangling_2018] 
